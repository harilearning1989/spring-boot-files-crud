...
import com.web.demo.utils.AppicationConstants;
    ...
    public List<IndiaStatesDTO> get() {
        ...
        CompletableFuture<List<IndiaStatesDTO>> fileReadFuture1 =
                supplyAsync(() -> {
                    ...
                    try {
                        return new CsvToBeanBuilder(new FileReader(AppicationConstants.DOWNLOAD_LOCATION + "csv/IndiaStates1.csv"))
        ...
        CompletableFuture<List<IndiaStatesDTO>> fileReadFuture2 =
                supplyAsync(() -> {
                    ...
                    try {
                        return new CsvToBeanBuilder(new FileReader(AppicationConstants.DOWNLOAD_LOCATION + "csv/IndiaStates2.csv"))
                                .withType(IndiaStatesDTO.class)
                                .build()
                                .parse();
                    } catch (FileNotFoundException e) {
